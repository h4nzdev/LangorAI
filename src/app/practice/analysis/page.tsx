...
export default function SessionAnalysis() {
  const skillMetrics = [
    { 
      label: 'Fluency', 
      value: 90, 
      desc: 'Great pacing with very few pauses.',
      icon: <Zap className="h-4 w-4 text-primary" />
    },
    { 
      label: 'Grammar', 
      value: 78, 
      desc: 'Minor issues with verb tenses in past narrative.',
      icon: <CheckCircle2 className="h-4 w-4 text-primary" />
    },
    { 
      label: 'Pronunciation', 
      value: 82, 
      desc: 'Clear articulation. Focus on "th" sounds.',
      icon: <Target className="h-4 w-4 text-primary" />
    },
    { 
      label: 'Vocabulary', 
      value: 88, 
      desc: 'Used several advanced idiomatic expressions.',
  ...
  const improvements = [
    {
      error: "I have go to the store yesterday.",
      correction: "I went to the store yesterday.",
      rule: "Past simple is used for finished actions in the past."
    },
    {
      error: "She don't like coffee.",
      correction: "She doesn't like coffee.",
      rule: "Use 'doesn't' for third-person singular (he/she/it)."
    }
  ];
        ...
        <div className="max-w-xl mx-auto px-6 space-y-10">
          ...
          <div className="flex flex-col items-center justify-center pt-4">
            <div className="relative w-48 h-48 flex items-center justify-center">
              {/* Simple SVG for circular progress */}
            ...
            <p className="mt-6 text-sm text-center font-medium text-white/90">
              Excellent session! You sounded more natural.
            </p>
          </div>
            ...
            <div className="relative group overflow-hidden bg-gradient-to-br from-[#1A2333] to-[#0B121F] border border-primary/20 rounded-3xl p-6 shadow-2xl">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-black">Mastering Past Tenses</h3>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Based on your session, we recommend this 5-minute interactive exercise to polish your storytelling skills.
                  </p>
                </div>
